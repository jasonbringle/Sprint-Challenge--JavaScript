...
const unisWithUni = graduates.filter(grads => grads.tostring = 'Uni');
...
*/
const lowPopulationAnimals = zooAnimals.filter(pop => pop = pop.population < 5);
...
*/
const populationTotal = zooAnimals.reduce(function(populationTotal, population){
  return populationTotal + population.population;},0);
